...
class ViewController: UIViewController {
    ...
    func matchColorLogic() -> Bool{
		...
		//Define answer as a random color
		var answerColor = self.myColors.fetchRandomColor()
		var wrongColor1 = self.myColors.fetchRandomColor()
		var wrongColor2 = self.myColors.fetchRandomColor()
        ...
        lblChangeColor.backgroundColor = self.myColors.hexStringToUIColor(answerColor.hexValue)
        
        lblTotalCorrect.text = "Total Correct: \(totalCorrect)"
        
        if(buttonAnswer == 0){
            btnAnswer1OUTLET.setTitle(answerColor.colorName, forState: UIControlState.Normal)
            btnAnswer2OUTLET.setTitle(wrongColor1.colorName, forState: UIControlState.Normal)
            btnAnswer3OUTLET.setTitle(wrongColor2.colorName, forState: UIControlState.Normal)
            button1Correct = true;
            
        }
        
        if(buttonAnswer == 1){
            btnAnswer1OUTLET.setTitle(wrongColor1.colorName, forState: UIControlState.Normal)
            btnAnswer2OUTLET.setTitle(answerColor.colorName, forState: UIControlState.Normal)
            btnAnswer3OUTLET.setTitle(wrongColor2.colorName, forState: UIControlState.Normal)
            button2Correct = true
        }
        
        if(buttonAnswer == 2){
            btnAnswer1OUTLET.setTitle(wrongColor2.colorName, forState: UIControlState.Normal)
            btnAnswer2OUTLET.setTitle(wrongColor1.colorName, forState: UIControlState.Normal)
            btnAnswer3OUTLET.setTitle(answerColor.colorName, forState: UIControlState.Normal)
            button3Correct = true
        }
